...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application ECU_A_SYSTEM
...
#--- OIL file
oilSourceList.append("ecu_com.oil")
...
cSourceList.append(projfile.ProjectFile("ecu_com.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ecu_com/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ecu_com/tpl_os.c"))
