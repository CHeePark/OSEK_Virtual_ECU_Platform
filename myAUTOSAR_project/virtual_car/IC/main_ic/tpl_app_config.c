 ...
 *
 * OS data structure generated from application IC_SYSTEM
 * Automatically generated by goil on Www Mmm dd hh:mm:ss yyyy
 * from root OIL file main_ic.oil
 *
...
#define Event_Display_Update_mask 1
CONST(EventMaskType, AUTOMATIC) Event_Display_Update = Event_Display_Update_mask;

/*=============================================================================
 * Declaration of processes IDs
 */

/* Task Task_Display_Update identifier */
#define Task_Display_Update_id 0
CONST(TaskType, AUTOMATIC) Task_Display_Update = Task_Display_Update_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task Task_Display_Update descriptor
 */
#define APP_Task_Task_Display_Update_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task Task_Display_Update function prototype
 */

FUNC(void, OS_APPL_CODE) Task_Display_Update_function(void);
#define APP_Task_Task_Display_Update_STOP_SEC_CODE
 ...
 */
/*
 * Task Task_Display_Update stack
 */
#define APP_Task_Task_Display_Update_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word Task_Display_Update_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_Task_Display_Update_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK Task_Display_Update_stack = {Task_Display_Update_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define Task_Display_Update_STACK &Task_Display_Update_stack

/*
 * Task Task_Display_Update context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT Task_Display_Update_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define Task_Display_Update_CONTEXT &Task_Display_Update_context
...
/*
 * Static descriptor of task Task_Display_Update
 */
CONST(tpl_proc_static, OS_CONST) Task_Display_Update_task_stat_desc = {
  /* context                  */  Task_Display_Update_CONTEXT,
  /* stack                    */  Task_Display_Update_STACK,
  /* entry point (function)   */  Task_Display_Update_function,
  /* internal ressource       */  NULL,
  /* task id                  */  Task_Display_Update_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task Task_Display_Update
 */
VAR(tpl_proc, OS_VAR) Task_Display_Update_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  ,    
#endif /* WITH_OSAPPLICATION */
...
/*
 * Event structure of task Task_Display_Update
 */
VAR(tpl_task_events, OS_VAR) Task_Display_Update_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
