...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application IC_SYSTEM
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file main_ic.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates/ main_ic.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("main_ic/tpl_app_config.c")

sourceList.append("main_ic/tpl_os.c")
