...
DeclareTask(Task_Application_Process);
DeclareTask(Task_CanIf_RxIndication);
DeclareTask(Task_PduR_RxIndication);
DeclareAlarm(Alarm_Simulate_CAN_Rx);
DeclareEvent(Event_PDU_Received);
DeclareEvent(Event_Signal_Available);
