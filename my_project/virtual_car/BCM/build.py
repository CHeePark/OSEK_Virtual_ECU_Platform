...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application BCM_SYSTEM
...
#--- OIL file
oilSourceList.append("main_bcm.oil")
...
cSourceList.append(projfile.ProjectFile("bcm_can_client.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("main_bcm/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("main_bcm/tpl_os.c"))
