...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application IC_SYSTEM
...
#--- OIL file
oilSourceList.append("main_ic.oil")
...
cSourceList.append(projfile.ProjectFile("main_ic.c"))
cSourceList.append(projfile.ProjectFile("display_update.c"))
cSourceList.append(projfile.ProjectFile("can_receiver.c"))
cSourceList.append(projfile.ProjectFile("ic_can_client.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("main_ic/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("main_ic/tpl_os.c"))
