...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application PCM_SYSTEM
...
includeDirs += ["-I","../../..//machines/posix"]
includeDirs += ["-I","../../..//machines/../viper"]
if with_ioc:
  includeDirs += ["-I", "../../..//ioc"]
includeDirs += ["-I", "../../..//com"]
includeDirs += ["-I", "../../..//os"]
includeDirs += ["-I", "../../..//debug"]
includeDirs += ["-I", "main_pcm"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("main_pcm.oil")
...
cSourceList.append(projfile.ProjectFile("main_pcm.c"))
cSourceList.append(projfile.ProjectFile("engine_control.c"))
cSourceList.append(projfile.ProjectFile("gear_control.c"))
cSourceList.append(projfile.ProjectFile("pcm_can_client.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("main_pcm/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("main_pcm/tpl_os.c"))
...
postVariableMapping = dict(
  ...
  ARCH_PATH='../../..//machines/posix',
  BOARD_PATH='../../..//machines/posix/linux',
  TARGET='posix/linux'
)
