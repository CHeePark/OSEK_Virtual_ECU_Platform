...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application PCM_SYSTEM
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file main_pcm.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates/ main_pcm.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "main_pcm.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=posix/linux", "--templates=../../../goil/templates/"]
...
#--- Add generated files
sourceList.append("main_pcm/tpl_app_config.c")

sourceList.append("main_pcm/tpl_os.c")
